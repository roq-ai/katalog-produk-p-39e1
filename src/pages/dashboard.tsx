...
import { useRoqPlatformUserProfiles, useTableCount, useRestaurantCount, useReservationCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const restaurantStat = useRestaurantCount();
