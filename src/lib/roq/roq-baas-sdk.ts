...
import type { Prisma, menu, reservation, restaurant, table, team, user } from './types';
...
interface RestaurantSDK {
  create: <
    ...
    U extends Omit<Prisma.restaurantCreateArgs, 'data'> & {
      data: Omit<Prisma.restaurantUncheckedCreateInput, 'menu' | 'table'>;
    },
  >(
    data: Prisma.SelectSubset<U, T>,
    options?: RequestOptions,
  ...
  update: <
    ...
    U extends Omit<Prisma.restaurantUpdateArgs, 'data'> & {
      data: Omit<Prisma.restaurantUncheckedUpdateInput, 'menu' | 'table'>;
    },
  >(
    data: Prisma.SelectSubset<U, T>,
    options?: RequestOptions,
...
interface UserSDK {
  create: <
    ...
    U extends Omit<Prisma.userCreateArgs, 'data'> & {
      data: Omit<Prisma.userUncheckedCreateInput, 'reservation' | 'restaurant' | 'table'>;
    },
  >(
    data: Prisma.SelectSubset<U, T>,
    options?: RequestOptions,
  ...
  update: <
    ...
    U extends Omit<Prisma.userUpdateArgs, 'data'> & {
      data: Omit<Prisma.userUncheckedUpdateInput, 'reservation' | 'restaurant' | 'table'>;
    },
  >(
    data: Prisma.SelectSubset<U, T>,
    options?: RequestOptions,
